...
if __name__ == "__main__":
    ...
    while 1:
        ...
        print("星火:", end="")
        main(
            appid="426d86d7",  # 填写控制台中获取的 APPID 信息
            api_secret="NDNlODE4MzI2NTYzZmVlYTI3NzI1Yjcw",  # 填写控制台中获取的 APISecret 信息
            api_key="66baa8fd08eabbf53dbfaa5ab21a8e63",  # 填写控制台中获取的 APIKey 信息
