...
if __name__ == '__main__':
    ...
    adv_string_init = open(args.init_prompt_path, 'r',encoding='utf-8').readlines()#加上了utf-8，解决UnicodeDecodeError: 'gbk' codec can't decode byte 0x9d in position 99: illegal multibyte sequence
