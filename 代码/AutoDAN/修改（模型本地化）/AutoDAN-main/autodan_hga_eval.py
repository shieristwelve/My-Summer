...
if __name__ == '__main__':
    ...
    template_name = "./models/llama2/llama-2-7b-chat-hf"
    ...
    model_path = "C:/Users/shier/Desktop/llama2/llama-2-7b-chat-hf"
    model_name = "./models/llama2/llama-2-7b-chat-hf"

    model, tokenizer = AutoTokenizer.from_pretrained('tokenizer_dir', tokenizer_class=AutoTokenizer)
